        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white">
          ...
          <div class="navbar-nav">
            <li class="nav-item  rounded-circle mx-2 search-icon">
             <!-- <script async src="https://cse.google.com/cse.js?cx=97d3b6b304ffec4cf"></script>
<div class="gcse-search"></div>  -->
              <form action="index.html" method="post">
                <input type="text" id="searchBar" placeholder="" value="Search..." maxlength="30" autocomplete="off"
                onmousedown="active();" onblur="inactive();"/><input type="submit" id="searchBtn" value="Go!">
              </form> 
              <?php
                ...
                echo $num_rows;
              ?>
              <i class="fas fa-search p-2 d-none"></i>
            </li>
            <li class="nav-item  rounded-circle mx-2 basket-icon">
              <i class="fas fa-shopping-basket p-2 d-none"></i>
            </li>
          </div>
        </nav>
      </div>
          ...
          <div class="slider-three row text-center px-4">
            ...
            <div class="col-md-2 product pt-md-5">
              ...
              <div class="cart-details">
                ...
                <div class="pro-price py-2">
                  <h5>
                    <small><s class="text-secondary">£119.99</s></small>
                    <span>£103</span>
                  </h5>
                </div>
                <div class="cart mt-4">
            ...
            <div class="col-md-2 product pt-md-5">
              ...
              <div class="cart-details">
                ...
                <div class="pro-price py-2">
                  <h5>
                    <small><s class="text-secondary">£469.99</s></small>
                    <span>£449.99</span>
                  </h5>
                </div>
                <div class="cart mt-4">
            ...
            <div class="col-md-2 product pt-md-5">
              ...
              <div class="cart-details">
                ...
                <div class="pro-price py-2">
                  <h5>
                    <small><s class="text-secondary">£259.99</s></small>
                    <span>£240.00</span>
                  </h5>
                </div>
                <div class="cart mt-4">
            ...
            <div class="col-md-2 product pt-md-5">
              ...
              <div class="cart-details">
                ...
                <div class="pro-price py-2">
                  <h5>
                    <small><s class="text-secondary">£139.99</s></small>
                    <span>£125.00</span>
                  </h5>
                </div>
                <div class="cart mt-4">
          ...
          <div class="col-md-6 col-12">
              <div class="row box">
                ...
                <div class="col-md-8 p-0 bg-white">
                  <div class="text-left">
                    <img src="./assets/1_11.jpg" alt="Sofa" class="img-fluid">
                  </div>
                </div>
              </div>
          </div>
      ...
      <div class="container-fluid">
        <div class="site-slider-four px-md-4">
          <div class="slider-four row text-center">
              <div class="col-md-2 product pt-md-5">
                <img src="./assets/1_11.jpg" class="border img-fluid" alt="Product 1">
              </div>
              <div class="col-md-2 product pt-md-5">
                <img src="./assets/3_20.jpg" class="border img-fluid" alt="Product 2">
              </div>
              <div class="col-md-2 product pt-md-5">
                <img src="./assets/6_19.jpg" class="border img-fluid" alt="Product 3">
              </div>
              <div class="col-md-2 product pt-md-5">
                <img src="./assets/8_20.jpg" class="border img-fluid" alt="Product 4">
              </div>
              <div class="col-md-2 product pt-md-5">
                <img src="./assets/11_18.jpg" class="border img-fluid" alt="Product 5">
              </div>
              <div class="col-md-2 product pt-md-5">
                <img src="./assets/15_3.jpg" class="border img-fluid" alt="Product 6">
              </div>
          </div>
          <div class="slider-btn">
            <span class="prev position-top"
    ...
    <div class="container-fluid">
      <div class="slider-brand">
        <div class="slider-five px-5">
            <div>
              <img src="./assets/item-7.jpg" alt="Brand 1" class="img-fluid">
            </div>
            <div>
                <img src="./assets/item-8.jpg" alt="Brand 2" class="img-fluid">
            </div>
            <div>
                <img src="./assets/item-9.jpg" alt="Brand 3" class="img-fluid">
            </div>
            <div>
                <img src="./assets/item-10.jpg" alt="Brand 4" class="img-fluid">
            </div>
            <div>
                <img src="./assets/item-8.jpg" alt="Brand 2" class="img-fluid">
            </div>
    ...
    <div class="container-fluid p-0">
      <div class="slider-client">
        <div class="slider-box text-center">
            <h1 class="pt-5 font-roboto">What Our Client Say?</h1>
            <div class="slider-six">
              <div>
                ...
                <h5 class="m-0">Irinel Lazarovici</h5>
                <small class="pb-1">CEO Lazarovici Web Design</small>
              </div>
              <div>
                  <p>
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil
  ...
  <!-- /Our Client -->
    ...
    <footer>
        ...
        <div class="container text-center">
          ...
          <small class="text-secondary py-4">© Lazarovici Web Design 2020. All Rights Reserved.</small>
        </div>
